...
namespace TickTrader.FDK.Client
{
    public class QuoteFeed : IDisposable
    {
        ...
        public delegate void TwoFactorLoginRequestDelegate(QuoteFeed quoteFeed, string message);
        public delegate void TwoFactorLoginResultDelegate(QuoteFeed quoteFeed, object data, DateTime expireTime);
        public delegate void TwoFactorLoginErrorDelegate(QuoteFeed quoteFeed, object data, Exception exception);
        public delegate void TwoFactorLoginResumeDelegate(QuoteFeed quoteFeed, object data, DateTime expireTime);
