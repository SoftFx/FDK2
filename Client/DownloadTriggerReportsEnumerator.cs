...
{
    public class DownloadTriggerReportsEnumerator : IDisposable
    {
        internal DownloadTriggerReportsEnumerator(TradeCapture tradeCapture)
        {
        ...
        public void Close()
        {
            lock (mutex_)
            {
                if (!completed_)
                {
                    ...
                    try
                    {
                        tradeCapture_.CancelDownloadTriggerReportsAsync(null, id_);
                    }
                    catch
                    {
                    }
