...
{
    public class DownloadBarsEnumerator : IDisposable
    {
        public DownloadBarsEnumerator(QuoteStore quoteStore)
        {
        ...
        public void Close()
        {
            lock (mutex_)
            {
                if (!completed_)
                {
                    ...
                    try
                    {
                        quoteStore_.CancelDownloadBarsAsync(null, downloadId_);
                    }
                    catch
                    {
                    }
        ...
        public void SetBegin(string downloadId, DateTime availFrom, DateTime availTo)
        {
            lock (mutex_)
            {
                if (! completed_)
