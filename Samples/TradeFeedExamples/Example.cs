namespace TradeFeedExamples
{
    ...
    abstract class Example : IDisposable
    {
        ...
        void OnDataTradeLogon(object sender, LogonEventArgs e)
        {
            Console.WriteLine("OnDataTradeLogon(): {0}", e);
        }

        void OnDataTradeLogout(object sender, LogoutEventArgs e)
        {
            Console.WriteLine("OnDataTradeLogout(): {0}", e);
        }

        void OnDataFeedLogon(object sender, LogonEventArgs e)
        {
            Console.WriteLine("OnDataFeedLogon(): {0}", e);
        }

        void OnDataFeedLogout(object sender, LogoutEventArgs e)
        {
